...
} from './runtime/composables/useNinjaToasterState';

import { Icon } from '@rootnode/@iconify/vue';
import BaseCard from '../../resources/js/vue/components/base/BaseCard.vue';
import BaseButtonClose from '../../resources/js/vue/components/base/BaseButtonClose.vue';
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="iconBgClasses"
    >
      <Icon :icon="props.icon" class="size-6" :class="iconClasses" />
    </div>
