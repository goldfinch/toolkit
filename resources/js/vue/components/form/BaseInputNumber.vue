...
import { computed, ref, onBeforeUnmount } from "@rootnode/vue";
  ...
  >
    ...
    <div class="nui-input-number-outer" :class="props.classes?.outer">
      <div>
        ...
        >
          <slot name="icon">
            <Icon :icon="props.icon" class="nui-input-number-icon-inner" />
          </slot>
        </div>
